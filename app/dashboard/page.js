...
export default function ChatClient() {
  ...
  return (
    <div className="flex flex-col sm:flex-row h-screen overflow-hidden">
      <div className="bg-black sm:h-full w-full sm:w-[150px] overflow-y-auto flex sm:flex-col whitespace-nowrap sm:whitespace-normal border-r border-white/10">
        {rooms.map((room, idx) => (
          <div
            key={idx}
            className="text-white px-4 py-2 border-b border-white/10"
          >
            <button
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-4 sm:px-16 py-4 sm:py-0">
        {error && (
          <div className="absolute top-6 right-6 bg-red-500 text-white px-4 py-2 rounded shadow-md animate-pulse z-50">
            {error}
          </div>
        )}
        <div className="w-full sm:w-[70vw] h-[70vh] sm:h-[80vh] bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-lg flex flex-col overflow-hidden">
